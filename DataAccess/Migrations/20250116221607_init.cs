    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelPromotion", x => new { x.HotelsId, x.PromotionsPromotionId });
                    table.ForeignKey(
                        name: "FK_HotelPromotion_Promotion_PromotionsPromotionId",
                        column: x => x.PromotionsPromotionId,
                        principalTable: "Promotion",
                        principalColumn: "PromotionId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_HotelPromotion_hotels_HotelsId",
                        column: x => x.HotelsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicableHotelsAndRooms = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_hotelpromotions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_hotelpromotions_Promotion_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotion",
                        principalColumn: "PromotionId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_hotelpromotions_hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Availbility = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelPromotion_PromotionsPromotionId",
                table: "HotelPromotion",
                column: "PromotionsPromotionId");

            migrationBuilder.CreateIndex(
                name: "IX_hotelpromotions_HotelId",
                table: "hotelpromotions",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_hotelpromotions_PromotionId",
                table: "hotelpromotions",
                column: "PromotionId");
